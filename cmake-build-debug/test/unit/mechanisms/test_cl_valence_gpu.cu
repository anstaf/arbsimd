...
auto& _pp_var_ion_cl __attribute__((unused)) = params_.ion_states[0];\
auto* _pp_var_ion_cl_index __attribute__((unused)) = params_.ion_states[0].index;\
//End of IFACEBLOCK
...
void compute_currents(arb_mechanism_ppack params_) {
    ...
    PPACK_IFACE_BLOCK;
    if (tid_<n_) {
        auto ion_cl_indexi_ = _pp_var_ion_cl_index[tid_];
        ...
        _pp_var_ion_cl.current_density[ion_cl_indexi_] = fma(10.0*_pp_var_weight[tid_], icl, _pp_var_ion_cl.current_density[ion_cl_indexi_]);
    }
}

} // namespace

void mechanism_test_cl_valence_gpu_init_(arb_mechanism_ppack* p) {}

void mechanism_test_cl_valence_gpu_compute_currents_(arb_mechanism_ppack* p) {
    auto n = p->width;
...
void mechanism_test_cl_valence_gpu_advance_state_(arb_mechanism_ppack* p) {}

void mechanism_test_cl_valence_gpu_write_ions_(arb_mechanism_ppack* p) {}

void mechanism_test_cl_valence_gpu_post_event_(arb_mechanism_ppack* p) {}
void mechanism_test_cl_valence_gpu_apply_events_(arb_mechanism_ppack* p, arb_deliverable_event_stream* events) {}
