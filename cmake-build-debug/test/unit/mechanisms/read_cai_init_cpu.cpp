...
namespace testing {
namespace kernel_read_cai_init {
...
extern "C" {
  arb_mechanism_interface* make_testing_read_cai_init_interface_multicore() {
    ...
    result.partition_width = testing::kernel_read_cai_init::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_read_cai_init::min_align_;
    result.init_mechanism = testing::kernel_read_cai_init::init;
    result.compute_currents = testing::kernel_read_cai_init::compute_currents;
    result.apply_events = testing::kernel_read_cai_init::apply_events;
    result.advance_state = testing::kernel_read_cai_init::advance_state;
    result.write_ions = testing::kernel_read_cai_init::write_ions;
    result.post_event = testing::kernel_read_cai_init::post_event;
    return &result;
  }}
