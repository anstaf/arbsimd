...
extern "C" {
  arb_mechanism_type make_testing_test_ca_read_valence() {
    // Tables
    static arb_field_info globals[] = {  };
    static arb_size_type n_globals = 0;
    static arb_field_info state_vars[] = { { "record_z", "", NAN, -.000000, .000000 } };
    static arb_size_type n_state_vars = 1;
    static arb_field_info parameters[] = {  };
    static arb_size_type n_parameters = 0;
    static arb_ion_info ions[] = { { "ca", false, false, false, false, true, false, 0 } };
    ...
    result.name="test_ca_read_valence";
