...
auto _pp_var_xi0 __attribute__((unused)) = params_.globals[0];\
auto _pp_var_xo0 __attribute__((unused)) = params_.globals[1];\
auto _pp_var_s0 __attribute__((unused)) = params_.globals[2];\
...
void init(arb_mechanism_ppack params_) {
    ...
    if (tid_<n_) {
        ...
        arb_value_type xo = 0;
        arb_value_type xi = 0;
        _pp_var_s[tid_] = _pp_var_s0;
        xi = _pp_var_xi0;
        xo = _pp_var_xo0;
        _pp_var_ion_x.external_concentration[ion_x_indexi_] = fma(_pp_var_weight[tid_], xo, _pp_var_ion_x.external_concentration[ion_x_indexi_]);
        _pp_var_ion_x.internal_concentration[ion_x_indexi_] = fma(_pp_var_weight[tid_], xi, _pp_var_ion_x.internal_concentration[ion_x_indexi_]);
    }
}
...
void mechanism_write_Xi_Xo_gpu_init_(arb_mechanism_ppack* p) {
    auto n = p->width;
...
void mechanism_write_Xi_Xo_gpu_compute_currents_(arb_mechanism_ppack* p) {
    auto n = p->width;
    unsigned block_dim = 128;
    unsigned grid_dim = ::arb::gpu::impl::block_count(n, block_dim);
...
void mechanism_write_Xi_Xo_gpu_advance_state_(arb_mechanism_ppack* p) {}

void mechanism_write_Xi_Xo_gpu_write_ions_(arb_mechanism_ppack* p) {}

void mechanism_write_Xi_Xo_gpu_post_event_(arb_mechanism_ppack* p) {}
void mechanism_write_Xi_Xo_gpu_apply_events_(arb_mechanism_ppack* p, arb_deliverable_event_stream* events) {}
