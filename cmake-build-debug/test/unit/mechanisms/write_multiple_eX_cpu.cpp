...
namespace testing {
namespace kernel_write_multiple_eX {
...
[[maybe_unused]] auto& _pp_var_ion_y = pp->ion_states[1];\
[[maybe_unused]] auto* _pp_var_ion_y_index = pp->ion_states[1].index;\
//End of IFACEBLOCK
...
static void init(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        auto ion_y_indexi_ = _pp_var_ion_y_index[i_];
        arb_value_type yi = _pp_var_ion_y.internal_concentration[ion_y_indexi_];
        arb_value_type xi = _pp_var_ion_x.internal_concentration[ion_x_indexi_];
        arb_value_type ey = 0;
        arb_value_type ex = 0;
        ex =  100.0+xi;
        ey =  200.0+yi;
        _pp_var_ion_y.reversal_potential[ion_y_indexi_] = ey;
...
extern "C" {
  arb_mechanism_interface* make_testing_write_multiple_eX_interface_multicore() {
    ...
    result.partition_width = testing::kernel_write_multiple_eX::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_write_multiple_eX::min_align_;
    result.init_mechanism = testing::kernel_write_multiple_eX::init;
    result.compute_currents = testing::kernel_write_multiple_eX::compute_currents;
    result.apply_events = testing::kernel_write_multiple_eX::apply_events;
    result.advance_state = testing::kernel_write_multiple_eX::advance_state;
    result.write_ions = testing::kernel_write_multiple_eX::write_ions;
    result.post_event = testing::kernel_write_multiple_eX::post_event;
    return &result;
  }}
