...
[[maybe_unused]] auto* _pp_var_d = pp->state_vars[0];\
//End of IFACEBLOCK
...
extern "C" {
  arb_mechanism_interface* make_testing_diam_test_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_diam_test::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_diam_test::min_align_;
    result.init_mechanism = testing::kernel_diam_test::init;
    result.compute_currents = testing::kernel_diam_test::compute_currents;
    result.apply_events = testing::kernel_diam_test::apply_events;
    result.advance_state = testing::kernel_diam_test::advance_state;
    result.write_ions = testing::kernel_diam_test::write_ions;
    result.post_event = testing::kernel_diam_test::post_event;
    return &result;
  }}
