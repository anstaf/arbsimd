...
void compute_currents(arb_mechanism_ppack params_) {
    ...
    if (tid_<n_) {
        ...
        arb_value_type i = 0;
        i = _pp_var_g[tid_]*(v-v_peer-_pp_var_e[tid_]);
        current_ = i;
...
void mechanism_gj1_gpu_init_(arb_mechanism_ppack* p) {}

void mechanism_gj1_gpu_compute_currents_(arb_mechanism_ppack* p) {
    auto n = p->width;
...
void mechanism_gj1_gpu_advance_state_(arb_mechanism_ppack* p) {}

void mechanism_gj1_gpu_write_ions_(arb_mechanism_ppack* p) {}

void mechanism_gj1_gpu_post_event_(arb_mechanism_ppack* p) {}
void mechanism_gj1_gpu_apply_events_(arb_mechanism_ppack* p, arb_deliverable_event_stream* events) {}
