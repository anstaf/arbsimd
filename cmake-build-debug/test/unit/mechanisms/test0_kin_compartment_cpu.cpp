...
namespace testing {
namespace kernel_test0_kin_compartment {
...
static void advance_state(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        a_0_ =  1.0- -1.0*alpha2*dt*( 1.0/_pp_var_B);
        a_1_ =  -( -1.0* -beta2*dt*( 1.0/_pp_var_A));
        a_2_ =  1.0- -beta1*dt*( 1.0/_pp_var_A);
        a_3_ =  -(alpha1*dt*( 1.0/_pp_var_A));
        a_4_ =  -(alpha2*dt*( 1.0/_pp_var_B));
        a_5_ =  -( -1.0* -beta1*dt*( 1.0/_pp_var_A));
        a_6_ =  1.0-( -1.0*alpha1+ -beta2)*dt*( 1.0/_pp_var_A);
        t_0_ = a_2_*a_4_;
        t_1_ = a_2_*a_6_-a_5_*a_3_;
        t_2_ = a_2_*_pp_var_s[i_]-a_5_*_pp_var_h[i_];
        t_3_ = a_0_*t_1_-t_0_*a_1_;
        t_4_ = a_0_*t_2_-t_0_*_pp_var_d[i_];
        t_5_ = t_3_*a_0_;
        t_6_ = t_3_*_pp_var_d[i_]-a_1_*t_4_;
        t_7_ = t_3_*a_2_;
        t_8_ = t_3_*_pp_var_h[i_]-a_3_*t_4_;
...
extern "C" {
  arb_mechanism_interface* make_testing_test0_kin_compartment_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_test0_kin_compartment::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_test0_kin_compartment::min_align_;
    result.init_mechanism = testing::kernel_test0_kin_compartment::init;
    result.compute_currents = testing::kernel_test0_kin_compartment::compute_currents;
    result.apply_events = testing::kernel_test0_kin_compartment::apply_events;
    result.advance_state = testing::kernel_test0_kin_compartment::advance_state;
    result.write_ions = testing::kernel_test0_kin_compartment::write_ions;
    result.post_event = testing::kernel_test0_kin_compartment::post_event;
    return &result;
  }}
