...
[[maybe_unused]] auto _pp_var_decay = pp->globals[0];\
[[maybe_unused]] auto _pp_var_cai0 = pp->globals[1];\
[[maybe_unused]] auto _pp_var_factor = pp->globals[2];\
...
static void advance_state(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        ll1_ =  0.;
        ll0_ =  0.;
        a_0_ =  -1.0/_pp_var_decay;
        ba_0_ = (_pp_var_cai0/_pp_var_decay-_pp_var_factor*ica)/a_0_;
        ll0_ = a_0_*dt;
...
extern "C" {
  arb_mechanism_interface* make_testing_test_ca_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_test_ca::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_test_ca::min_align_;
    result.init_mechanism = testing::kernel_test_ca::init;
    result.compute_currents = testing::kernel_test_ca::compute_currents;
    result.apply_events = testing::kernel_test_ca::apply_events;
    result.advance_state = testing::kernel_test_ca::advance_state;
    result.write_ions = testing::kernel_test_ca::write_ions;
    result.post_event = testing::kernel_test_ca::post_event;
    return &result;
  }}
