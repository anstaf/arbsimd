...
static void compute_currents(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        arb_value_type i = 0;
        i = _pp_var_g[i_]*(v-v_peer-_pp_var_e[i_]);
        current_ = i;
...
extern "C" {
  arb_mechanism_interface* make_testing_gj1_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_gj1::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_gj1::min_align_;
    result.init_mechanism = testing::kernel_gj1::init;
    result.compute_currents = testing::kernel_gj1::compute_currents;
    result.apply_events = testing::kernel_gj1::apply_events;
    result.advance_state = testing::kernel_gj1::advance_state;
    result.write_ions = testing::kernel_gj1::write_ions;
    result.post_event = testing::kernel_gj1::post_event;
    return &result;
  }}
