...
auto* _pp_var_p __attribute__((unused)) = params_.state_vars[0];\
//End of IFACEBLOCK
...
void mechanism_test6_nonlinear_diff_gpu_init_(arb_mechanism_ppack* p) {
    auto n = p->width;
...
void mechanism_test6_nonlinear_diff_gpu_compute_currents_(arb_mechanism_ppack* p) {}

void mechanism_test6_nonlinear_diff_gpu_advance_state_(arb_mechanism_ppack* p) {
    auto n = p->width;
    unsigned block_dim = 128;
    unsigned grid_dim = ::arb::gpu::impl::block_count(n, block_dim);
...
void mechanism_test6_nonlinear_diff_gpu_write_ions_(arb_mechanism_ppack* p) {}

void mechanism_test6_nonlinear_diff_gpu_post_event_(arb_mechanism_ppack* p) {}
void mechanism_test6_nonlinear_diff_gpu_apply_events_(arb_mechanism_ppack* p, arb_deliverable_event_stream* events) {}
