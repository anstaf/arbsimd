...
namespace testing {
namespace kernel_linear_ca_conc {
...
[[maybe_unused]] auto* _pp_var_coeff = pp->parameters[0];\
...
extern "C" {
  arb_mechanism_interface* make_testing_linear_ca_conc_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_linear_ca_conc::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_linear_ca_conc::min_align_;
    result.init_mechanism = testing::kernel_linear_ca_conc::init;
    result.compute_currents = testing::kernel_linear_ca_conc::compute_currents;
    result.apply_events = testing::kernel_linear_ca_conc::apply_events;
    result.advance_state = testing::kernel_linear_ca_conc::advance_state;
    result.write_ions = testing::kernel_linear_ca_conc::write_ions;
    result.post_event = testing::kernel_linear_ca_conc::post_event;
    return &result;
  }}
