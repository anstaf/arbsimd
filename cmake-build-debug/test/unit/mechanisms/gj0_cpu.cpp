...
extern "C" {
  arb_mechanism_interface* make_testing_gj0_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_gj0::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_gj0::min_align_;
    result.init_mechanism = testing::kernel_gj0::init;
    result.compute_currents = testing::kernel_gj0::compute_currents;
    result.apply_events = testing::kernel_gj0::apply_events;
    result.advance_state = testing::kernel_gj0::advance_state;
    result.write_ions = testing::kernel_gj0::write_ions;
    result.post_event = testing::kernel_gj0::post_event;
    return &result;
  }}
