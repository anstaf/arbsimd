...
[[maybe_unused]] auto _pp_var_xi0 = pp->globals[0];\
[[maybe_unused]] auto _pp_var_xo0 = pp->globals[1];\
[[maybe_unused]] auto _pp_var_s0 = pp->globals[2];\
...
static void init(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        arb_value_type xo = 0;
        arb_value_type xi = 0;
        _pp_var_s[i_] = _pp_var_s0;
        xi = _pp_var_xi0;
        xo = _pp_var_xo0;
        _pp_var_ion_x.external_concentration[ion_x_indexi_] = fma(_pp_var_weight[i_], xo, _pp_var_ion_x.external_concentration[ion_x_indexi_]);
        _pp_var_ion_x.internal_concentration[ion_x_indexi_] = fma(_pp_var_weight[i_], xi, _pp_var_ion_x.internal_concentration[ion_x_indexi_]);
    }
...
extern "C" {
  arb_mechanism_interface* make_testing_write_Xi_Xo_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_write_Xi_Xo::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_write_Xi_Xo::min_align_;
    result.init_mechanism = testing::kernel_write_Xi_Xo::init;
    result.compute_currents = testing::kernel_write_Xi_Xo::compute_currents;
    result.apply_events = testing::kernel_write_Xi_Xo::apply_events;
    result.advance_state = testing::kernel_write_Xi_Xo::advance_state;
    result.write_ions = testing::kernel_write_Xi_Xo::write_ions;
    result.post_event = testing::kernel_write_Xi_Xo::post_event;
    return &result;
  }}
