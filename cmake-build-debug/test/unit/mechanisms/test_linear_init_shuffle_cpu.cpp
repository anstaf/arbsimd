...
namespace testing {
namespace kernel_test_linear_init_shuffle {
...
static void init(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        l_4_ =  -_pp_var_a0[i_]- -_pp_var_a1[i_];
        l_5_ =  0.;
        l_6_ =  1.0;
        l_7_ =  1.0;
        l_8_ =  1.0;
...
extern "C" {
  arb_mechanism_interface* make_testing_test_linear_init_shuffle_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_test_linear_init_shuffle::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_test_linear_init_shuffle::min_align_;
    result.init_mechanism = testing::kernel_test_linear_init_shuffle::init;
    result.compute_currents = testing::kernel_test_linear_init_shuffle::compute_currents;
    result.apply_events = testing::kernel_test_linear_init_shuffle::apply_events;
    result.advance_state = testing::kernel_test_linear_init_shuffle::advance_state;
    result.write_ions = testing::kernel_test_linear_init_shuffle::write_ions;
    result.post_event = testing::kernel_test_linear_init_shuffle::post_event;
    return &result;
  }}
