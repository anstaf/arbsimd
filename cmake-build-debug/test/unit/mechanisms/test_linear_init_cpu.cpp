...
namespace testing {
namespace kernel_test_linear_init {
...
extern "C" {
  arb_mechanism_interface* make_testing_test_linear_init_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_test_linear_init::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_test_linear_init::min_align_;
    result.init_mechanism = testing::kernel_test_linear_init::init;
    result.compute_currents = testing::kernel_test_linear_init::compute_currents;
    result.apply_events = testing::kernel_test_linear_init::apply_events;
    result.advance_state = testing::kernel_test_linear_init::advance_state;
    result.write_ions = testing::kernel_test_linear_init::write_ions;
    result.post_event = testing::kernel_test_linear_init::post_event;
    return &result;
  }}
