...
namespace testing {
namespace kernel_test0_kin_steadystate {
...
extern "C" {
  arb_mechanism_interface* make_testing_test0_kin_steadystate_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_test0_kin_steadystate::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_test0_kin_steadystate::min_align_;
    result.init_mechanism = testing::kernel_test0_kin_steadystate::init;
    result.compute_currents = testing::kernel_test0_kin_steadystate::compute_currents;
    result.apply_events = testing::kernel_test0_kin_steadystate::apply_events;
    result.advance_state = testing::kernel_test0_kin_steadystate::advance_state;
    result.write_ions = testing::kernel_test0_kin_steadystate::write_ions;
    result.post_event = testing::kernel_test0_kin_steadystate::post_event;
    return &result;
  }}
