...
extern "C" {
  arb_mechanism_type make_testing_diam_test() {
    // Tables
    static arb_field_info globals[] = {  };
    static arb_size_type n_globals = 0;
    static arb_field_info state_vars[] = { { "d", "", NAN, -.000000, .000000 } };
