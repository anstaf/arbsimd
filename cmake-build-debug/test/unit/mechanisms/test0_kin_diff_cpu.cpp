...
namespace testing {
namespace kernel_test0_kin_diff {
...
extern "C" {
  arb_mechanism_interface* make_testing_test0_kin_diff_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_test0_kin_diff::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_test0_kin_diff::min_align_;
    result.init_mechanism = testing::kernel_test0_kin_diff::init;
    result.compute_currents = testing::kernel_test0_kin_diff::compute_currents;
    result.apply_events = testing::kernel_test0_kin_diff::apply_events;
    result.advance_state = testing::kernel_test0_kin_diff::advance_state;
    result.write_ions = testing::kernel_test0_kin_diff::write_ions;
    result.post_event = testing::kernel_test0_kin_diff::post_event;
    return &result;
  }}
