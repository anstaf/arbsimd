...
extern "C" {
  arb_mechanism_type make_testing_write_cai_breakpoint() {
    // Tables
    static arb_field_info globals[] = {  };
    static arb_size_type n_globals = 0;
    static arb_field_info state_vars[] = { { "cai", "", NAN, -.000000, .000000 } };
    ...
    result.name="write_cai_breakpoint";
