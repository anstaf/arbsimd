...
namespace testing {
namespace kernel_param_as_state {
...
[[maybe_unused]] auto* _pp_var_p = pp->parameters[0];\
//End of IFACEBLOCK
...
extern "C" {
  arb_mechanism_interface* make_testing_param_as_state_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = testing::kernel_param_as_state::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = testing::kernel_param_as_state::min_align_;
    result.init_mechanism = testing::kernel_param_as_state::init;
    result.compute_currents = testing::kernel_param_as_state::compute_currents;
    result.apply_events = testing::kernel_param_as_state::apply_events;
    result.advance_state = testing::kernel_param_as_state::advance_state;
    result.write_ions = testing::kernel_param_as_state::write_ions;
    result.post_event = testing::kernel_param_as_state::post_event;
    return &result;
  }}
