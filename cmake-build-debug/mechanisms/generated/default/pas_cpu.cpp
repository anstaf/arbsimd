...
[[maybe_unused]] auto _pp_var_e = pp->globals[0];\
...
extern "C" {
  arb_mechanism_interface* make_arb_default_catalogue_pas_interface_multicore() {
    ...
    result.partition_width = arb::default_catalogue::kernel_pas::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = arb::default_catalogue::kernel_pas::min_align_;
    result.init_mechanism = arb::default_catalogue::kernel_pas::init;
    result.compute_currents = arb::default_catalogue::kernel_pas::compute_currents;
    result.apply_events = arb::default_catalogue::kernel_pas::apply_events;
    result.advance_state = arb::default_catalogue::kernel_pas::advance_state;
    result.write_ions = arb::default_catalogue::kernel_pas::write_ions;
    result.post_event = arb::default_catalogue::kernel_pas::post_event;
    return &result;
  }}
