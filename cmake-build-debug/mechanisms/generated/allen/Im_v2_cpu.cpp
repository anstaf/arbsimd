...
extern "C" {
  arb_mechanism_interface* make_arb_allen_catalogue_Im_v2_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = arb::allen_catalogue::kernel_Im_v2::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = arb::allen_catalogue::kernel_Im_v2::min_align_;
    result.init_mechanism = arb::allen_catalogue::kernel_Im_v2::init;
    result.compute_currents = arb::allen_catalogue::kernel_Im_v2::compute_currents;
    result.apply_events = arb::allen_catalogue::kernel_Im_v2::apply_events;
    result.advance_state = arb::allen_catalogue::kernel_Im_v2::advance_state;
    result.write_ions = arb::allen_catalogue::kernel_Im_v2::write_ions;
    result.post_event = arb::allen_catalogue::kernel_Im_v2::post_event;
    return &result;
  }}
