...
extern "C" {
  arb_mechanism_interface* make_arb_allen_catalogue_NaTs_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = arb::allen_catalogue::kernel_NaTs::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = arb::allen_catalogue::kernel_NaTs::min_align_;
    result.init_mechanism = arb::allen_catalogue::kernel_NaTs::init;
    result.compute_currents = arb::allen_catalogue::kernel_NaTs::compute_currents;
    result.apply_events = arb::allen_catalogue::kernel_NaTs::apply_events;
    result.advance_state = arb::allen_catalogue::kernel_NaTs::advance_state;
    result.write_ions = arb::allen_catalogue::kernel_NaTs::write_ions;
    result.post_event = arb::allen_catalogue::kernel_NaTs::post_event;
    return &result;
  }}
