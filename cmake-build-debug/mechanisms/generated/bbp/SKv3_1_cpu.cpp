...
[[maybe_unused]] auto* _pp_var_gSKv3_1bar = pp->parameters[0];\
...
static void init(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        _pp_var_m[i_] =  1.0/( 1.0+exp(( 18.699999999999999-v)* 0.10309278350515465));
    }
...
static void compute_currents(arb_mechanism_ppack* pp) {
    ...
    for (arb_size_type i_ = 0; i_ < _pp_var_width; ++i_) {
        ...
        arb_value_type v = _pp_var_vec_v[node_indexi_];
        arb_value_type ik = 0;
        ik = _pp_var_gSKv3_1bar[i_]*_pp_var_m[i_]*(v-ek);
        current_ = ik;
        conductivity_ = _pp_var_gSKv3_1bar[i_]*_pp_var_m[i_];
...
extern "C" {
  arb_mechanism_interface* make_arb_bbp_catalogue_SKv3_1_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = arb::bbp_catalogue::kernel_SKv3_1::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = arb::bbp_catalogue::kernel_SKv3_1::min_align_;
    result.init_mechanism = arb::bbp_catalogue::kernel_SKv3_1::init;
    result.compute_currents = arb::bbp_catalogue::kernel_SKv3_1::compute_currents;
    result.apply_events = arb::bbp_catalogue::kernel_SKv3_1::apply_events;
    result.advance_state = arb::bbp_catalogue::kernel_SKv3_1::advance_state;
    result.write_ions = arb::bbp_catalogue::kernel_SKv3_1::write_ions;
    result.post_event = arb::bbp_catalogue::kernel_SKv3_1::post_event;
    return &result;
  }}
